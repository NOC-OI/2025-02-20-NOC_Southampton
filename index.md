...
address: "451a, National Oceanography Centre, European Way, Southampton, SO14 3ZH"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
<strong>Some adblockers block the registration window. If you do not see the
  registration box below, please go directly to the <a href="https://2025-02-20-python-and-conda.eventbrite.com">registration page.</a></strong>
...
<p>
<strong><a href="https://carpentries.org">About The Carpentries:</a></strong> The Carpentries project comprises the <a
...
{% if site.carpentry == "swc" %}
This schedule is still being refined and may be changed slightly. 
